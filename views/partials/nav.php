                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            <?php else: ?>
                                ...
                                <a href="/register" class="<?= urlIs('/register') ? "bg-gray-900 text-white" : "text-gray-300" ?>rounded-md  px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                                    Register
                                </a>
                            <?php endif; ?>
                        </div>
